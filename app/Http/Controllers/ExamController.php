...
class ExamController extends Controller
{
    ...
    public function assignExam(Quiz $qui,Request $request){
         $quiz = $qui->assignExam($request->all());
         return redirect()->back()->with('message', 'Exam has been assigned to user successfully');
    }
    ...
    public function getQuizQuestions(Quiz $qui, $quizId){
        ...
        ->whereIn('quiz_id', $qui->hasQuizAttempted())->pluck('quiz_id')->toArray();
